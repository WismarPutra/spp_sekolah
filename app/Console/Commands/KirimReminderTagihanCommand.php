...
{
    protected $signature = 'tagihan:reminder-otomatis';
    protected $description = 'Kirim reminder atau Surat Panggilan WA tanggal 25';
    ...
    public function handle()
    {
        ...
        $this->info('Proses pengiriman reminder/surat panggilan tanggal 25 berhasil dijalankan.');
    }
}