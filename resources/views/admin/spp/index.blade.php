            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-150">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-700 whitespace-nowrap uppercase">{{ $item->jurusan }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center justify-center gap-3">
                                ...
                                <form action="{{ route('spp.destroy', $item->id) }}" method="POST" class="form-delete" onsubmit="return confirm('Yakin ingin menghapus data SPP ini?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
